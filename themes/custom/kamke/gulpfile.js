...
options.theme = {
  ...
  components : options.rootPath.theme + 'assets/sass',
  build      : options.rootPath.theme + 'assets/css',
  styleguide : options.rootPath.theme + 'assets/style-guide',
...
options.drupalURL = 'jonkamke.dev';
